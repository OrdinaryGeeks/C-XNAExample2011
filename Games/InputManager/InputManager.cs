...
namespace SmellOfRevenge2011
{
    public class InputManager
 {
        ...
        public bool MaxCombo { get 
        { return maxCombo; }
            set
            { maxCombo = value; }
        }
        /// <summary>
        /// 2012 Oct change + 200 for the hold for additional combo
        ...
        /// </summary>
        public readonly TimeSpan BufferTimeOut = TimeSpan.FromMilliseconds(1500);

        
        /// <summary>
        /// 2012 OCT change from 500 to 1000 to only accept combo while in hold mode
        ...
        /// </summary>
        public readonly TimeSpan MergeInputTime = TimeSpan.FromMilliseconds(1000);
        ...
        public void Update(GameTime gameTime)
        {
            ...
            var direction = Directional.FromInput(GamePadState, KeyboardState);
            if (!maxCombo)
            {
                if (Directional.FromInput(lastGamePadState, lastKeyboardState) != direction)
                {
