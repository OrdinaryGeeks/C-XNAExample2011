...
namespace SmellOfRevenge2011
{
    class MenuListEntry
    {
        ...
        /// </summary>
        public MenuListEntry(string text)
        {
            this.text = text;
                                 ...
                                 bool isSelected, GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, choices[index], new Vector2(position.X + font.MeasureString(text).X + 5, position.Y), color, 0, origin,
