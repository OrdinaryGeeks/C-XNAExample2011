...
namespace SmellOfRevenge2011
{
   public class SpearMan : Character
   {
       ...
       public Matrix[] standing, brace, atk1a, atk1b, atk1c, atk1d,
           ...
           spearSpin1, spearSpin2, spearSpin3, spearSpin4, spearSpin5, spearSpin6,
           flySpear1, flySpear2, flySpear3, spearPin1, spearPin2, spearPin3,
           spearThrow1, spearThrow2, spearThrow3, spearThrow4;
       ...
       public void updateFlySpear1(GameTime gameTime)
       {
           currentAnimationTime += TimeSpan.FromTicks(gameTime.ElapsedGameTime.Ticks * 3);
       ...
       public void updateSpear1(GameTime gameTime)
       {
           currentAnimationTime += TimeSpan.FromTicks(gameTime.ElapsedGameTime.Ticks * 3);
           if (currentAnimationTime.TotalSeconds < 3.0f)
           {
       ...
       Matrix.CreateTranslation(Vector3.Lerp(trans, trans2, (float)(currentAnimationTime.TotalSeconds - 2.0) / 1.0f));
           ...
           else
           {
               ...
               if (isSpearSpin)
               {
                   spear3.CopyTo(previousAnimation, 0);
                   openStrike = true;
               }
               else
                   active = false;
